/*
  ...
  - Added the required column `timeTaken` to the `Seizure` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "timeTaken" TIMESTAMP(3) NOT NULL,
