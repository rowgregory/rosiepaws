...
export const INTAKE_TYPES = [
  { id: 'milliliters', name: 'Exact Amount', icon: '📏', description: 'Record in mL' },
  { id: 'relative', name: 'Relative Amount', icon: '📊', description: 'Compare to usual' }
]

export const RELATIVE_AMOUNTS = [
  {
    id: 'more',
    label: 'Drinking More',
    icon: '💧💧💧',
