  ...
  return (
    <>
      <div className="bg-[#e8e4c5] w-full h-[970px] overflow-hidden relative flex items-center justify-center">
        ...
        <div className="bg-herologo4 bg-center bg-contain bg-no-repeat absolute z-20 w-full h-full max-w-[750px] max-h-[750px] flex items-center justify-center animate-floatCloud"></div>
      </div>
    </>
  )
}
