...
const Header = () => {
  return (
    <header className="relative bg-[#fffdf8] bg-homeherotexture2 bg-repeat bg-contain bg-center h-[92px] w-full flex items-center justify-center after:absolute after:content-[''] after:w-11/12 after:h-2 after:bg-roseblush after:top-0 after:rounded-br-3xl after:rounded-bl-3xl after:bg-homeherotexture2">
