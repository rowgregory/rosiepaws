...
const MiniGuardianBloodSugarGraph = ({ chartData }: any) => {
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="text-right">
          <div className="text-2xl font-bold text-pink-600">{chartData.bloodSugar?.slice(-1)[0]?.value || '--'}</div>
...
export default MiniGuardianBloodSugarGraph
