...
import { formatAppointmentDate, formatAppointmentTime } from '@/app/lib/utils/appointment'
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900">{formatAppointmentTime(nextAppointment.time)}</div>
