...
const MiniGuardianFeedingChart = ({ chartData }: any) => {
  const foodTypeData =
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="text-right">
          <div className="text-2xl font-bold text-green-600">
            {foodTypeData.reduce((sum: any, item: any) => sum + item.count, 0)}
          </div>
          <div className="text-sm text-gray-500">Total Feedings</div>
        </div>
      </div>
...
export default MiniGuardianFeedingChart
