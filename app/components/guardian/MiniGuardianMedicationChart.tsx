...
const MiniGuardianMedicationChart: React.FC<GuardianMiniMedicationChartProps> = ({
  medications = [],
  className = ''
}) => {
      ...
      {uniqueMedications.length > 0 ? (
        ...
        <div className="mb-6 h-[200px] flex items-center justify-center bg-gray-50 rounded-lg">
          <div className="text-center">
            ...
            <h4 className="text-lg font-medium text-gray-600 mb-1">No Medications</h4>
            <p className="text-sm text-gray-500">No current prescriptions on file</p>
          </div>
        </div>
      )}
...
export default MiniGuardianMedicationChart
