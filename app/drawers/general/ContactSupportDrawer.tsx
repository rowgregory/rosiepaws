...
import { setCloseContactSupporteDrawer, setOpenSlideMessage } from '../../redux/features/appSlice'
...
const ContactSupportDrawer = () => {
  ...
  const [createTicket, { data, error: errorCreate }] = useCreateTicketMutation() as any
                    ...
                    >
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                        <p className="text-blue-800 text-sm">
                          We&apos;ve sent a confirmation email to <strong>{data?.ticket?.email}</strong> with your
                          ticket details.
                        </p>
                      </div>
