...
const ContactSupportDrawer = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      submitData.append('deviceInfo', navigator.userAgent)
                  ...
                  >
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-mono text-green-900">#{ticketNumber}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-green-700">Category:</span>
                          <span className="text-green-900">{selectedCategory?.title}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-green-700">Priority:</span>
                          <span className="text-green-900 capitalize">{formData.priority}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-green-700">Expected Response:</span>
                          <span className="text-green-900">
                            {priorities.find((p) => p.id === formData.priority)?.response}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                      <p className="text-blue-800 text-sm">
                        We&apos;ve sent a confirmation email to <strong>{formData.email}</strong> with your ticket
                        details.
                      </p>
                    </div>
