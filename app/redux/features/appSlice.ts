...
export const appSlice = createSlice({
  ...
  reducers: {
    ...
    setOpenChangePlanModal: (state) => {
      state.changePlanModal = true
    },
    setCloseChangePlanModal: (state) => {
      state.changePlanModal = false
    }
  },
...
export const {
  ...
  setToggleNavigation,
  setOpenChangePlanModal,
  setCloseChangePlanModal
} = appSlice.actions
